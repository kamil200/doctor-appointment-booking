  ...
  return (
    <div>
      <div className="mb-[50px]">
        <h4 className="text-[20px] leading-[30px] font-bold text-headingColor mb-[30px]">All Reviews (100)</h4>
        <div className="flex justify-between gap-10 mb-[30px]">
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className='text__para mt-3 font-medium text-[15px]'>Good Services, highly recommanded 👍</p>
            </div>
          </div>
