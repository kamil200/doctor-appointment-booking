      ...
      <div className="max-w-[1170px] px-5 mx-auto ">
        <div className="grid md:grid-cols-3 gap-[50px] ">
          <div className="md:col-span-2 ">
            ...
            ">
              <figure className='max-w-[200px] max-h-[200px] '><img src={doctorImg} alt="" className='w-full ' /></figure>
              <div>
                ...
                <h3 className=' text-headingColor text-[22px] leading-9 mt-3 font-bold  '>Alfaz Ahmed</h3>
                ...
                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>With over 15 years of experience, Dr. Alfaz Ahmed is dedicated to improving heart health. Patients rely on his expertise for managing cardiac conditions and preventive care.</p>
              </div>
            </div>
