    ...
    return (
        <div className="p-3 lg:p-5">
            ...
            <div className='mt-[18px] lg:mt-5 flex items-center justify-between '>
                <div>
                    <h3 className=' text-[16px] leading-7 lg:text-[18px] lg:leading-[3opx] font-semibold text-headingColor '>+{totalPatients}</h3>
                ...
                mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none"> <BsArrowRight className=" group-hover:text-white w-6 h-5" />  </Link>
            </div>
        </div>
    )
}
